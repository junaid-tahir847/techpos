...
{
    public abstract class TechPOSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TechPOSWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TechPOSWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TechPOSDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TechPOSDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TechPOSDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TechPOSDbContext, Task<T>> func)
        {
            T result;
